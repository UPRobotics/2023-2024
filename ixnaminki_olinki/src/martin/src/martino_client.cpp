...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<structuras::srv::Movement>::SharedPtr client =
    node->create_client<structuras::srv::Movement>("direcciones");

  auto request = std::make_shared<structuras::srv::Movement::Request>();
  request->direction = atoll(argv[1]);
    request->direction2 = atoll(argv[2]);
